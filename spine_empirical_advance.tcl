...
### these two intervals are for QueueCluster
set interval_message [lindex $argv 38]     
set interval_qlet [lindex $argv 39]
...
Agent/TCP/FullTcp set enable_known_ false
Agent/TCP/FullTcp set enable_ddl_ false
...
Agent/TCP/FullTcp set thres_message_ $interval_message
...
if {[string compare $switchAlg "Known"] == 0 } {
    Agent/TCP/FullTcp set enable_known_ true
}
...
Queue/ClusterQueueMap set queue_num_ $prio_num_
Queue/ClusterQueueMap set thresh_ $DCTCP_K
Queue/ClusterQueueMap set mean_pktsize_ [expr $pktSize+40]
Queue/ClusterQueueMap set marking_scheme_ $ECN_scheme_
Queue/ClusterQueueMap set interval_msg_ $interval_message
Queue/ClusterQueueMap set interval_qlet_ $interval_qlet

Queue/ClusterQueueSketch set queue_num_ $prio_num_
Queue/ClusterQueueSketch set thresh_ $DCTCP_K
Queue/ClusterQueueSketch set mean_pktsize_ [expr $pktSize+40]
Queue/ClusterQueueSketch set marking_scheme_ $ECN_scheme_
Queue/ClusterQueueSketch set interval_msg_ $interval_message
Queue/ClusterQueueSketch set interval_qlet_ $interval_qlet
