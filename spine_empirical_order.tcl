...
Queue/ClusterQueueOrderMap set queue_num_ $prio_num_
Queue/ClusterQueueOrderMap set thresh_ $DCTCP_K
Queue/ClusterQueueOrderMap set mean_pktsize_ [expr $pktSize+40]
Queue/ClusterQueueOrderMap set marking_scheme_ $ECN_scheme_
Queue/ClusterQueueOrderMap set interval_msg_ $interval_message

Queue/ClusterQueueOrderSketch set queue_num_ $prio_num_
Queue/ClusterQueueOrderSketch set thresh_ $DCTCP_K
Queue/ClusterQueueOrderSketch set mean_pktsize_ [expr $pktSize+40]
Queue/ClusterQueueOrderSketch set marking_scheme_ $ECN_scheme_
Queue/ClusterQueueOrderSketch set interval_msg_ $interval_message
