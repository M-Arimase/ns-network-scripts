...
Queue/Unknown set queue_num_ $prio_num_
Queue/Unknown set thresh_ $DCTCP_K
Queue/Unknown set mean_pktsize_ [expr $pktSize+40]
Queue/Unknown set marking_scheme_ $ECN_scheme_

Queue/Appro_Unknown set queue_num_ $prio_num_
Queue/Appro_Unknown set thresh_ $DCTCP_K
Queue/Appro_Unknown set mean_pktsize_ [expr $pktSize+40]
Queue/Appro_Unknown set marking_scheme_ $ECN_scheme_
Queue/Appro_Unknown set interval_ $interval_message
