...
TCP_pair instproc flow_finished {} {
    ...
    set ordered_cnt [$tcpr get_ordered_packet_number]
    set unorder_cnt [$tcpr get_unorder_packet_number]
    set ordered_sum [$tcpr get_ordered_packet_sum_number]
    set unorder_sum [$tcpr get_unorder_packet_sum_number]

    set unorder_prop [expr 1.0 * $ordered_cnt / ($ordered_cnt + $unorder_cnt)]
    set unorder_sump [expr 1.0 * $ordered_sum / ($ordered_sum + $unorder_sum)]

    puts "orderinfo: $ordered_cnt $unorder_cnt $ordered_sum $unorder_sum $unorder_prop $unorder_sump"
    # **************** modified by zhaoyk ******************
}
